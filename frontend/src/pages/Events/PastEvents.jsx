      ...
      <section className="relative bg-slate-900 py-14 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          <div className="max-w-3xl mx-auto">
            <h5 className="text-indigo-400 font-semibold tracking-wider uppercase text-sm mb-3">
          ...
          <div className="bg-white rounded-xl shadow-xl border border-slate-100 p-2 md:p-4 flex flex-col md:flex-row gap-4 items-center justify-between backdrop-blur-md bg-white/95">
            ...
            <div className="relative w-full md:w-96">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:bg-white outline-none transition-all"
              />
            </div>
          ...
          {loading ? (
            ...
            <div className="space-y-8">
              {filteredEvents.map((event) => (
                <div
                  key={event.id}
                  className="group bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-xl hover:border-indigo-100 transition-all duration-300 overflow-hidden relative" // Added relative here
                >
                    ...
                    <div className="flex flex-col md:flex-row h-full">
                      ...
                      <div className="md:w-1/3 relative overflow-hidden h-56 md:h-auto">
                        ...
                        <div className="absolute top-4 left-4 z-20">
                          <span className="px-3 py-1 bg-white/90 backdrop-blur text-indigo-900 text-xs font-bold tracking-wide uppercase rounded-md shadow-sm">
                            {event.category}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="md:w-2/3 p-6 md:p-8 flex flex-col justify-between">
                        ...
                        <div className="absolute top-0 right-0 m-4 md:m-6 p-3 rounded-full bg-indigo-500/10 text-indigo-600 opacity-0 group-hover:opacity-100 transform translate-x-3 group-hover:translate-x-0 transition-all duration-300 ease-out z-20">
